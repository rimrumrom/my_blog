    ...
    <div class="top-bar con-min-width">
        <div class="con flex flex-jc-sb">
            ...
            <a href="#" class="logo img-box flex flex-ai-c">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 108 82.9" xml:space="preserve">
                    <style type="text/css">
                        .st0 {
                            fill: #9C0A1F;
                        }
                    ...
                    <g class="st1">
                        <path class="st0" d="M81.3,82c-14.7,0-26.7-12-26.7-26.7s12-26.7,26.7-26.7s26.7,12,26.7,26.7S96,82,81.3,82z M81.3,31.6
                               c-13.1,0-23.7,10.6-23.7,23.7S68.3,79,81.3,79S105,68.4,105,55.3S94.4,31.6,81.3,31.6z"></path>
                    </g>
                    <g>
                        <g>
        ...
        <div class="swiper-container height-100p">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <video src="https://rimrumrom.github.io/img1/creation/%ED%95%9C%EC%8B%A0%EB%8B%AD%EB%B0%9C_20171103.mp4 " autoplay="autoplay" muted="muted" loop="loop"></video>
                </div>
                <div class="swiper-slide">
                    <div class="height-100p con flex flex-ai-c">
                        <h1>매콤한 국물이 별미 <br>태봉이 국물닭발</h1>
