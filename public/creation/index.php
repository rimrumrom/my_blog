            ...
            <div class="top-bar con flex flex-ai-c">
                <a href="/" class="logo flex-ai-c">
                    <svg version="1.1" class="logo-svg" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 108 82.9"
                        style="enable-background:new 0 0 108 82.9;" xml:space="preserve">
                        <style type="text/css">
                            .st0 {
                                fill: #9C0A1F;
                            }
                        ...
                        <g>
                            <g>
                                <path class="st2" d="M24.9,32H13.4v-3.1h28V32H29.8v25.7h-4.9L24.9,32L24.9,32z" />
                ...
                <a href="/" class="shop flex flex-ai-c">
                    <svg id="Layer_1" class="shop-svg" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 181 56.35">
                        <defs>
                            <style>
                                .cls-1 {
                                    fill: #231815;
                        ...
                        <rect class="cls-1" x="3" y="3.35" width="178" height="53" rx="12.73" />
                        <rect class="cls-2" width="178" height="53" rx="12.73" />
                        <path class="cls-3"
